...
# 链式代理菜单详细 - Chain Proxy Menu Detail Messages
...
MSG_CHAIN_SETUP_EXIT_DESC_1="# 工作原理:"
MSG_CHAIN_SETUP_EXIT_DESC_2="# 1. 出口节点接收来自入口/中继节点的流量"
MSG_CHAIN_SETUP_EXIT_DESC_3="# 2. 出口节点将流量转发到互联网"
MSG_CHAIN_SETUP_EXIT_DESC_4="# 3. 用户最终的出口 IP 为本机 IP"
...
MSG_CHAIN_CONFIG_COMPLETE="配置完成！"
MSG_CHAIN_COPY_CODE="链式代理配置码 (请复制到入口节点)"
MSG_CHAIN_KEEP_SECRET="请妥善保管配置码，切勿泄露！"
...
MSG_CHAIN_ROLE_ENTRY="入口节点 (Entry)"
MSG_CHAIN_ROLE_ENTRY_MULTI="入口节点 (Entry) - 多跳模式"
...
MSG_CHAIN_TEST_TCP="测试1: TCP端口连通性..."
MSG_CHAIN_TEST_FORWARD="测试2: 链路转发测试..."
...
MSG_EXT_PROTOCOL_SPLIT="按协议分流设置"
MSG_EXT_SELECT_PROTOCOLS="请选择走外部节点的协议 (多选用逗号分隔，如: 1,2)"
MSG_EXT_PROTOCOL_LIST="当前已安装的协议"
MSG_EXT_SELECTED_CHAIN="走外部节点"
MSG_EXT_SELECTED_DIRECT="直连"
MSG_EXT_NO_PROTOCOLS="未检测到已安装的协议"
MSG_EXT_CONFIRM_SPLIT="确认配置"
MSG_EXT_SPLIT_SUCCESS="分流配置完成"
MSG_USER="用户"
MSG_ENTRY_NODE="入口节点"
MSG_INTERNET="互联网"
MSG_OPTIONAL="可选"
